    ...
    return (
        <nav className="fixed inset-y-0 pt-16 left-0 bg-gray-200 dark:bg-gray-800 w-64 min-h-screen flex flex-col">
            ...
            <ul className="flex-1">
                {/* Link 1 */}
                <li>
                    <Link to="/submit-feedback" className="block py-2 px-6 text-gray-600 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-700">Submit Feedback</Link>
                </li>
                {/* Link 2 */}
                <li>
                    <Link to="/read-feedback" className="block py-2 px-6 text-gray-600 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-700">Read Feedback</Link>
                </li>
            </ul>
        </nav>
    );
