  ...
  return (
    <EBookPage currentPage={1} >
      ...
      <Section id="stored-program-machines">
        ...
        <Figure>
          <div>
            <img src={images.eniac.src} alt={images.eniac.alt} className="w-full h-[300px]" />
            <Description>
          ...
          <div>
            <img src={images.modernComputer.src} alt={images.modernComputer.alt} className="w-full h-[300px]" />
              <Description>
          ...
          <div>
            <img src={images.specialPurposeComputer.src} alt={images.specialPurposeComputer.src} className="w-full h-[300px]" />
            <Description>
